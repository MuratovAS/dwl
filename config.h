...
static const MonitorRule monrules[] = {
	/* name       mfact  nmaster scale tag layout       rotate/reflect                x    y */
	/* example of a HiDPI laptop monitor:
	{ "eDP-1",    0.5f,  1,      2,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
	*/
	/* defaults */
	//{ NULL,       0.55f, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
	{ "HDMI-A-1", 0.5,  2,      2,    0b000000001, &layouts[1], WL_OUTPUT_TRANSFORM_NORMAL,   0,  0 },
	{ "eDP-1",    0.5,  1,      1,    0b100000000, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   0,  1080 },
	{ NULL,       0.5,  1,      1,    0b010000000, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
};
